...
public class _16_BigDecimal {
	...
	public static void main(String[] args) {
		...
		// 1. BigDecimal 객체 생성
		// 1-1. 생성자를 통한 객체 생성
		BigDecimal bigDecimal1 = new BigDecimal(1.99999999999999999999999999999999999999999999999999999);
		...
		// MathContext의 생성자를 통해 객체를 생성할 떄 매개변수로
		...
		// 현재 소수점 자리수보다 큰 자리수를 지정하면 뒤에 0이 자동으로 붙는다.(반올림모드 지정하지 않아도 된다.)
