...
import chap21_multithread.thread.NonSyncThread01;
import chap21_multithread.thread.NonSyncThread02;
import chap21_multithread.thread.PrintNumWithoutSync;
...
public class _07_NonSyncSharedObj {
	...
	public static void main(String[] args) {
		...
		// 동기화되지 않은 공유객체는 변수갑이 계속 변경될 수 있기 때문에
