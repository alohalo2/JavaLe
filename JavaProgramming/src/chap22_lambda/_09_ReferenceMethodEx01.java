...
public class _09_ReferenceMethodEx01 {
	...
	// static 메소드를 참조하는 것처럼 메소드를 참조할 수 있
//	printConvertCase(s -> s.toLowerCase());
	...
	public static void printConvertCase(ConvertcaseString convertcaseString) {
		...
		System.out.println("입략받은 문자열: " + str);
		...
		// 람다식을 전달하면서 만들어진다.
		String converStr = convertcaseString.toConvertcase(str);
		
		System.out.println("변환된 문자열: " + converStr);
