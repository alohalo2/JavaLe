...
// MultiFlexStadium이 Stadium과 ConcerHall의 형태도 가지고 있기 때문에 
// SeoulMultiFlexStadium 클래스는
// stadium 타입의 변수에도 사용할 수 있고 ConcerHall 타입의 변수에도 사용할 수 있고
// MultiFlexStadium 타입의 변수에도 사용할 수 있으며 SeoulMultiFlexStadium 타입 변수로도 사용할 수 있다.
...
public class SeoulMultiFlexStadium extends Theater implements MultiFlexStadium {
	...
	public void playSportsgameOrConcert() {
		...
		System.out.println("토요일에는 수원 대 서울 경기가 진행되고" + "일요일에는 싸이 콘서드가 진행될 예정입니다.");
