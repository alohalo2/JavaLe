...
public enum MethodMonth {
	...
	public void printAddMonth(int month) {
		...
		if(this.monthValue + month <= 12) {
			System.out.println(month + "개월 뒤는 " + (this.monthValue + month) + "월 입니다.");
		} else {
			System.out.println(month + "개월 뒤는 " + 
					((this.monthValue + month) % 12) + "월 입니다.");
		}
		
		
		
//		int sum = (this.monthValue + month)%12;
//		
//		if((sum) < 12) {
//			System.out.println("");
//		} else if((this.monthValue + month) >= 12) {
//			
//			(this.monthValue + month) % 12
//		}
//			
//		
//		
