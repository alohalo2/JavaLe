...
public class _05_HashSet {
	...
	public static void main(String[] args) {
		...
		// 4. Set은 데이터의 순서가 없기 때문에 인덱스로 데이터에 접근할 수 있는 방법이 있다.
		...
		// Iterator의 hasNext(): 데이터가 남아있는지 검사하는 메소드, 남아있으념ㄴ true, 없으면 false
		while(iterator.hasNext()) {
			// Iterator의 next(): Iterator 객체를 생성할 떄 지정한 제네릭타입의 데이터를 하나씩 꺼내주는 메소드
