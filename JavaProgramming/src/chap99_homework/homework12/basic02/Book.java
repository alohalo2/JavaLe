...
//	2. 도서의 제목, 저자, 출판사, 가격을 속성으로 가지고 정보를 저장하는 메소드와 정보를 출력하는 메소드를 갖는 도서 클래스를 생성하세요.
	...
	public void bookInfo() {
		System.out.println("이 책의 제목은 " + this.title);
		System.out.println("이 책의 저자는 " + this.author);
		System.out.println("이 책의 출판사는 " + this.publisher);
		System.out.println("이 책의 가격은 " + this.price);
	}
