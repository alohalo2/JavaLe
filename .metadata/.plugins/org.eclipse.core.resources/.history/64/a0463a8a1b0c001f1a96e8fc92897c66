package chap99_homework04;

import java.util.Scanner;

import chap99_homework04.answer.ContractEmployee;
import chap99_homework04.answer.Employee;
import chap99_homework04.answer.RegularEmployee;
import chap99_homework04.answer.TempEmployee;
...
public class UseOfEmployee {
	...
	public static Employee generateEmployee(Scanner sc, int menuSelect) {
		 ...
		 if(menuSelect == 1) {
			 ...
			 return new RegularEmployee(eno, name, pay, menuSelect, hireYear);
		 } else {
			 System.out.println("근무일수를 입력하세요.");
			 int workDay = sc.nextInt();
			 
			 return new RegularEmployee(eno, name, pay, menuSelect, workDay);
		 }
